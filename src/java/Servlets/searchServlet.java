...
//                String keyword = (String) session.getAttribute("txtsearch");
...
//            }
            ...
            session.setAttribute("tmp1", tmp);
//            out.println("<p> the website in deploying in " + tmp + "</p>");
            String tmp2 = context.getInitParameter("language");
            session.setAttribute("tmp2", tmp2);

            session.setAttribute("plantList", list);
